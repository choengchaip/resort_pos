          ...
          children: <Widget>[
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Container(
                                margin: EdgeInsets.only(right: 10),
                                child: Icon(
                                  IconData(int.parse(_posService.getPosIcon()),
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      color: _productView == ProductView.TwoRow
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              style: _appFontStyle.getSmallButtonText(
                                  color: Color(
                                      int.parse(_posService.getPosColor()))),
                            ),
                          ),
                          Container(
                            margin: EdgeInsets.only(right: 25),
                        ...
                        children: List.generate(_list.length, (index){
                          return Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                Container(
                                  height: _posService.getWidth() / _posService.getRowNumber()-15,
                                  width: _posService.getWidth() / _posService.getRowNumber()-15,
                                  color: Color(int.parse(_posService.getPosColor())),
                                ),
                                Container(
                                  child: Text(_list[index],style: _appFontStyle.getSmallButtonText(),),
                                ),
                                Container(
                                  child: Text('100\$',style: _appFontStyle.getNormalText(color: Color(0xff656565)),),
                                ),
                              ],
                            ),
                          );
            ...
            Container(
              ...
              decoration: BoxDecoration(color: Colors.white, boxShadow: [
                BoxShadow(color: Color.fromRGBO(0, 0, 0, 0.3), blurRadius: 1)
              ]),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
